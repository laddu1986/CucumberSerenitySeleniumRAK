...
public class Reuasables {
	...
	public static void exchangeratevalidationRAKMoney(String Currency,WebDriver driver) {
		try {
			...
			Reuasables.waitElement(By.xpath("//div[@class='mbsc-fr-btn1 mbsc-fr-btn-e mbsc-fr-btn' and text()='Cancel']"),driver);
			...
			Reuasables.waitElement(By.xpath("//div[@class='fin-input-container rakTransfersexchangerate-block']/p[@class='rakexchangevalue ng-binding']"),driver);
